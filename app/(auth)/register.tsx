...
export default function Register() {
  ...
  return (
    <SafeAreaView className=" flex-col justify-center items-center bg-[#F9F9F9] h-full">
      <Text className=" text-3xl font-bold mb-8  px-5">Register</Text>
      <View className="w-full px-5 flex-col justify-center items-center">
        <TextInput
